...
PixiShare permet de visualiser ses photos de manière bien plus agréable que l'explorateur Windows. À terme, il offrira également la possibilité de partager des albums  de façon éphémère avec des amis et/ou des membres de la famille et quelques possibilité de modification des images (à définir).\
